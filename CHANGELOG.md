...
- Added `doctor`, `init`, `audit`, `review`, and `ship-check`.
- Added Markdown and JSON report writing.
- Added project detection for common JavaScript package managers and frameworks.
